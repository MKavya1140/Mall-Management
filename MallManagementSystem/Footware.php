   ...
   <head>
    ...
    <div class="form-group row col-md-offset-4">
        <div class="tab-pane fade in active">
            <h1 style="color: #000;font-weight: bold;margin-top: 2%;">Offers in Footware</h1>
        </div>        
    </div>
    <?php
    ...
    if ($con) {
        try {
            $qry = "SELECT * FROM `offers` where category='Footware' AND todate >= CURDATE() ORDER BY `offers`.`sno` ASC";
